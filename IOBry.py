...
def createBryFile(confM2R):
    ...
    print(('Creating initial Boundary (BRY) file {}'.format(confM2R.bryname)))

    f1             = Dataset(confM2R.bryname, mode='w', format=confM2R.myformat)
    f1.title       = "Boundary forcing file (BRY)"
    ...
    v_temp_west           = f1.createVariable('temp_west', 'f', ('ocean_time', 's_rho', 'eta_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
    ...
    v_temp_east           = f1.createVariable('temp_east', 'f', ('ocean_time', 's_rho', 'eta_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
    ...
    v_temp_south           = f1.createVariable('temp_south', 'f', ('ocean_time', 's_rho', 'xi_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
    ...
    v_temp_north           = f1.createVariable('temp_north', 'f', ('ocean_time', 's_rho', 'xi_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
    ...
    v_salt_west            = f1.createVariable('salt_west', 'f', ('ocean_time', 's_rho', 'eta_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
    ...
    v_salt_east            = f1.createVariable('salt_east', 'f', ('ocean_time', 's_rho', 'eta_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
    ...
    v_salt_south           = f1.createVariable('salt_south', 'f', ('ocean_time', 's_rho', 'xi_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
    ...
    v_salt_north           = f1.createVariable('salt_north', 'f', ('ocean_time', 's_rho', 'xi_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
    ...
    v_ssh_west           = f1.createVariable('zeta_west', 'f', ('ocean_time', 'eta_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
    ...
    v_ssh_east           = f1.createVariable('zeta_east', 'f', ('ocean_time', 'eta_rho',), zlib=myzlib, fill_value=grdROMS.fillval)
    ...
    v_ssh_south           = f1.createVariable('zeta_south', 'f', ('ocean_time', 'xi_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
    ...
    v_ssh_north           = f1.createVariable('zeta_north', 'f', ('ocean_time', 'xi_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
    ...
    v_u_west           = f1.createVariable('u_west', 'f', ('ocean_time', 's_rho', 'eta_u',), zlib=myzlib,fill_value=grdROMS.fillval)
    ...
    v_u_east           = f1.createVariable('u_east', 'f', ('ocean_time', 's_rho', 'eta_u',), zlib=myzlib,fill_value=grdROMS.fillval)
    ...
    v_u_south           = f1.createVariable('u_south', 'f', ('ocean_time', 's_rho', 'xi_u',), zlib=myzlib,fill_value=grdROMS.fillval)
    ...
    v_u_north           = f1.createVariable('u_north', 'f', ('ocean_time', 's_rho', 'xi_u',), zlib=myzlib,fill_value=grdROMS.fillval)
    ...
    v_v_west           = f1.createVariable('v_west', 'f', ('ocean_time', 's_rho', 'eta_v',), zlib=myzlib,fill_value=grdROMS.fillval)
    ...
    v_v_east           = f1.createVariable('v_east', 'f', ('ocean_time', 's_rho', 'eta_v',), zlib=myzlib,fill_value=grdROMS.fillval)
    ...
    v_v_south           = f1.createVariable('v_south', 'f', ('ocean_time', 's_rho', 'xi_v',), zlib=myzlib,fill_value=grdROMS.fillval)
    ...
    v_v_north           = f1.createVariable('v_north', 'f', ('ocean_time', 's_rho', 'xi_v',), zlib=myzlib, fill_value=grdROMS.fillval)
    ...
    v_vbar_west           = f1.createVariable('vbar_west', 'f', ('ocean_time', 'eta_v',), zlib=myzlib,fill_value=grdROMS.fillval)
    ...
    v_vbar_east           = f1.createVariable('vbar_east', 'f', ('ocean_time', 'eta_v',), zlib=myzlib,fill_value=grdROMS.fillval)
    ...
    v_vbar_south           = f1.createVariable('vbar_south', 'f', ('ocean_time', 'xi_v',), zlib=myzlib, fill_value=grdROMS.fillval)
    ...
    v_vbar_north           = f1.createVariable('vbar_north', 'f', ('ocean_time', 'xi_v',), zlib=myzlib,fill_value=grdROMS.fillval)
    ...
    v_ubar_west           = f1.createVariable('ubar_west', 'f', ('ocean_time', 'eta_u',), zlib=myzlib,fill_value=grdROMS.fillval)
    ...
    v_ubar_east           = f1.createVariable('ubar_east', 'f', ('ocean_time', 'eta_u',), zlib=myzlib,fill_value=grdROMS.fillval)
    ...
    v_ubar_south           = f1.createVariable('ubar_south', 'f', ('ocean_time', 'xi_u',), zlib=myzlib, fill_value=grdROMS.fillval)
    ...
    v_ubar_north           = f1.createVariable('ubar_north', 'f', ('ocean_time', 'xi_u',), zlib=myzlib,fill_value=grdROMS.fillval)
    ...
    if confM2R.writeice:
        ageice_west           = f1.createVariable('ageice_west', 'f', ('ocean_time', 'eta_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        ageice_east           = f1.createVariable('ageice_east', 'f', ('ocean_time', 'eta_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        ageice_south           = f1.createVariable('ageice_south', 'f', ('ocean_time', 'xi_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        ageice_north           = f1.createVariable('ageice_north', 'f', ('ocean_time', 'xi_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        uice_west           = f1.createVariable('uice_west', 'f', ('ocean_time', 'eta_u',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        uice_east           = f1.createVariable('uice_east', 'f', ('ocean_time', 'eta_u',), zlib=myzlib, fill_value=grdROMS.fillval)
        ...
        uice_south           = f1.createVariable('uice_south', 'f', ('ocean_time', 'xi_u',), zlib=myzlib, fill_value=grdROMS.fillval)
        ...
        uice_north           = f1.createVariable('uice_north', 'f', ('ocean_time', 'xi_u',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        vice_west           = f1.createVariable('vice_west', 'f', ('ocean_time', 'eta_v',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        vice_east           = f1.createVariable('vice_east', 'f', ('ocean_time', 'eta_v',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        vice_south           = f1.createVariable('vice_south', 'f', ('ocean_time', 'xi_v',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        vice_north           = f1.createVariable('vice_north', 'f', ('ocean_time', 'xi_v',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        aice_west           = f1.createVariable('aice_west', 'f', ('ocean_time', 'eta_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        aice_east           = f1.createVariable('aice_east', 'f', ('ocean_time', 'eta_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        aice_south           = f1.createVariable('aice_south', 'f', ('ocean_time', 'xi_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        aice_north           = f1.createVariable('aice_north', 'f', ('ocean_time', 'xi_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        hice_west           = f1.createVariable('hice_west', 'f', ('ocean_time', 'eta_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        hice_east           = f1.createVariable('hice_east', 'f', ('ocean_time', 'eta_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        hice_south           = f1.createVariable('hice_south', 'f', ('ocean_time', 'xi_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        hice_north           = f1.createVariable('hice_north', 'f', ('ocean_time', 'xi_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        snow_thick_west           = f1.createVariable('snow_thick_west', 'f', ('ocean_time', 'eta_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        snow_thick_east           = f1.createVariable('snow_thick_east', 'f', ('ocean_time', 'eta_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        snow_thick_south           = f1.createVariable('snow_thick_south', 'f', ('ocean_time', 'xi_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        snow_thick_north           = f1.createVariable('snow_thick_north', 'f', ('ocean_time', 'xi_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        ti_west           = f1.createVariable('ti_west', 'f', ('ocean_time', 'eta_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        ti_east           = f1.createVariable('ti_east', 'f', ('ocean_time', 'eta_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        ti_south           = f1.createVariable('ti_south', 'f', ('ocean_time', 'xi_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        ti_north           = f1.createVariable('ti_north', 'f', ('ocean_time', 'xi_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        sfwat_west           = f1.createVariable('sfwat_west', 'f', ('ocean_time', 'eta_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        sfwat_east           = f1.createVariable('sfwat_east', 'f', ('ocean_time', 'eta_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        sfwat_south           = f1.createVariable('sfwat_south', 'f', ('ocean_time', 'xi_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        sfwat_north           = f1.createVariable('sfwat_north', 'f', ('ocean_time', 'xi_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        tisrf_west           = f1.createVariable('tisrf_west', 'f', ('ocean_time', 'eta_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        tisrf_east           = f1.createVariable('tisrf_east', 'f', ('ocean_time', 'eta_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        tisrf_south           = f1.createVariable('tisrf_south', 'f', ('ocean_time', 'xi_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        tisrf_north           = f1.createVariable('tisrf_north', 'f', ('ocean_time', 'xi_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        sig11_west           = f1.createVariable('sig11_west', 'f', ('ocean_time', 'eta_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        sig11_east           = f1.createVariable('sig11_east', 'f', ('ocean_time', 'eta_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        sig11_south           = f1.createVariable('sig11_south', 'f', ('ocean_time', 'xi_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        sig11_north           = f1.createVariable('sig11_north', 'f', ('ocean_time', 'xi_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        sig12_west           = f1.createVariable('sig12_west', 'f', ('ocean_time', 'eta_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        sig12_east           = f1.createVariable('sig12_east', 'f', ('ocean_time', 'eta_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        sig12_south           = f1.createVariable('sig12_south', 'f', ('ocean_time', 'xi_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        sig12_north           = f1.createVariable('sig12_north', 'f', ('ocean_time', 'xi_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        sig22_west           = f1.createVariable('sig22_west', 'f', ('ocean_time', 'eta_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        sig22_east           = f1.createVariable('sig22_east', 'f', ('ocean_time', 'eta_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        sig22_south           = f1.createVariable('sig22_south', 'f', ('ocean_time', 'xi_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
        ...
        sig22_north           = f1.createVariable('sig22_north', 'f', ('ocean_time', 'xi_rho',), zlib=myzlib,fill_value=grdROMS.fillval)
